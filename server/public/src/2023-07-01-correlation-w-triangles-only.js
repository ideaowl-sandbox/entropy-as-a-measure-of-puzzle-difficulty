...
setTimeout(function(){
    ...
    d3.queue()
        ...
        // .defer(d3.json, './data/OUTPUT-windmillTrianglePMetas-much-fewer-0-solutions.json')

        .defer(d3.json, './data/OUTPUT-windmillTrianglePMetas-no-0-solutions.json')
    ...
    // 
        .awaitAll(function (err, [windmillPuzzles]) {
            ...
            filterPuzzlesSection.append('div')
                .text('toggle pure triangle puzzles and ProfessorDave3D puzzles')
                ...
                .on('click', function () {
                    ...
                    drawAbleWindmillPuzzles.forEach(pMeta => {
                        // if (pMeta.puzzleSetup.constraints.mustCrosses !== undefined) {
                            ...
                            if (pMeta.creator !== 'p5d9fe0') {
                                isSuchPuzzle = false;
                            }

                            if (pMeta.puzzleSetup.constraints.mustCrosses !== undefined
                                || pMeta.puzzleSetup.constraints.regionConstraints !== undefined
                                || pMeta.puzzleSetup.constraints.cannotCrosses !== undefined) {
                                isSuchPuzzle  = true;
                            }

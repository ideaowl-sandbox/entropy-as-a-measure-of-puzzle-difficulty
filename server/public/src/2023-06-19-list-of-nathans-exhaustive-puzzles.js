...
setTimeout(function(){
    ...
    d3.select('#updatesSection').each(function () {
        ...
        function showPuzzles(jump, forcedI) {
            ...
            puzzlesToShow.forEach(function (puzzleSetup) {
                let puzzleContainer = d3.select(puzzlesContainer.node())
                    .append('div')
                    .style('display', 'inline-block')
                    .style('width', '120px')
                
                new WitnessPuzzle(puzzleSetup, { classed: ['small'], targetElement: puzzleContainer.node(), render:true })

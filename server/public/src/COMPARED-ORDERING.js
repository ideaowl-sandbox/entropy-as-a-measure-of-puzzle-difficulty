...
setTimeout(function(){
    ...
    d3.queue()
        ...
        .defer(d3.json, './data/game-introduction-to-constraints-OUTPUT.json')
        // .defer(d3.json, './data/spread-curriculum-now-try-with-KL-OUTPUT.json')
        ...
        .awaitAll(function (err, [windmillPuzzles]) {
            ...
            d3.select('#updatesSection').each(function(){
                ...
                drawAbleWindmillPuzzles.forEach(function (pMeta) {
                    new WitnessPuzzle(pMeta.puzzleSetup, { classed: ['small'], targetElement: orderedPuzzlesContainer.node(), render: true  })
                }) 
                    ...
                    sortedPuzzlesContainer
                        ...
                        .each(function(metricVal) {
                            ...
                            relevantPuzzles.forEach(function (pMeta) {
                                new WitnessPuzzle(pMeta.puzzleSetup, { classed: ['small'], targetElement: currMetricValContainer, render: true })
                            }) 
                        })

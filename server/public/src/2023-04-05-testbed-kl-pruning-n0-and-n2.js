...
setTimeout(function(){
    ...
    d3.select('#testbed_kl_pruning_n0').style('display', 'block');




    d3.select('#kl_pruning_n0').selectAll("*").remove();
    ...
    let optionss = { 
        ...
        render: false
            ...
            testPuzzles.forEach((puzzleSetup,i) => {
                ...
                let puzzleSec = d3.select('#kl_pruning_n0')
                    .append('div')
                ...
                testPuzzle.deriveMinSolKLDivergenceEntropyWithPruningAndNdepth(0);
                testPuzzle.deriveMinSolKLDivergenceEntropyWithPruningAndNdepth(2);
                ...
                console.log(testPuzzle._state.puzzle.history.minSolKLDivergenceEntropyWithPruningAndN2)

...
setTimeout(function(){
    ...
    let deriveIGT = false;
    d3.queue()
        .defer(d3.json, './data/windmillUnencodedPuzzles-9-added-min--saved-entropy.json')
    ...
    // 
        .awaitAll(function (err, [windmillPuzzles]) {
            ...
            g.chartState = {
                yAxisMeasure: windmillPuzzles[0].measures[0].name,
                xAxisMeasure: windmillPuzzles[0].measures[1].name,
                sizeMeasure: windmillPuzzles[0].measures[2].name,
            }

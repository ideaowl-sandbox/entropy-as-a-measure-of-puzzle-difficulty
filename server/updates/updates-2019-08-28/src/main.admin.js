...
d3.select('#updatesSection').selectAll("*").remove();
            ...
            let optionss = { targetElement: '#updatesSection', renderImmediateLookAhead: true, userInterface: false };
            // let testPuzzle = new WitnessPuzzle(testPuzzleSetup, Object.assign({ classed: ['large'] }, optionss)); //options { render: false }    
            

            testPuzzles.forEach(puzzleSetup => new WitnessPuzzle(puzzleSetup, Object.assign({ classed: ['large'] }, optionss)))

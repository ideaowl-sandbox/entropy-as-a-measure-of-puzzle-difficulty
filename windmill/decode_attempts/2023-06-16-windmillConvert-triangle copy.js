import WitnessPuzzle from '../../server/lib/WitnessPuzzle/WitnessPuzzle.js';
import d3 from '../../server/lib/WitnessPuzzle/modules/_dependencies/d3/4.13.0/d3roll.min.js';
...
setTimeout(function(){
    ...
    d3.queue()
        .defer(d3.json, './windmillUnencodedPuzzles-all-regardless-of-constraints.json')

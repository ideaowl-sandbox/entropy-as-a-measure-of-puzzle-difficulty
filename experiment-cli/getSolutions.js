...
function extractPromise(puzzleSetup) {
    return new Promise(resolve => {
        // Spin up process
        const sub = childProcess.fork("./child-getSolutions.js");
...
async function asyncExtract(puzzleSetup, i) {
    console.log('Get solutions for puzzle ' + i)
    ...
    console.log('Obtained solutions for puzzle ' + i + ', ' + puzzlesLeft.length 
...
console.log('=================================================================')
console.log('Get Solutions from ' + puzzleSetups.length + ' puzzles with ' + maxActiveProcesses + ' concurrent processes')
console.log('=================================================================')
console.time('getPuzzleSolutions');
asyncLoop(allSyncExtracts, maxActiveProcesses);



function allResults(values) {
    fs.writeFileSync("./data/" + dataFilename + "-SOLUTIONS.json", JSON.stringify(values));
    console.timeEnd('getPuzzleSolutions');
}
